...
class Qwen4ExpPLEPageableHostEmbedding(Qwen4ExpPLEPinnedHostEmbedding):
    ...
    def bind_storage_after_loading(self) -> None:
        ...
        layout = discover_table_layout(
            resolve_local_checkpoint_dir(self._model_config),
            self.layer_index,
            self.org_vocab_size,
            self.embedding_dim,
            self.weight.dtype,
...
def resolve_local_checkpoint_dir(model_config) -> str:
    """The local directory holding the checkpoint (downloaded by the loader)."""
